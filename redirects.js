    ...
    redirects: [
        ...
        },
        {
            ...
            from: [
                ...
                '/general/run-a-node/set-up-your-node/governance', // #gen_cast_vote // #200 Restructure docs
                '/node/run-your-node/validator-node/governance', // #gen_cast_vote // #399 Replace oasis-node with Oasis CLI
            ],
        },
        {
