...
[your entity's nonce]: ../../general/manage-tokens/cli/account.mdx#show
...
Obtain [your entity's nonce](../../general/manage-tokens/cli/account.mdx#show) and store it in the `NONCE` variable. You can do that by running:
