...
* (optional) Vote for the upgrade. On 2022-04-01, an upgrade proposal will be
  ...
  See the [Governance documentation](../../core/oasis-node/cli.md#gen_cast_vote)
...
* (optional) Vote for the upgrade. On 2022-03-02, an upgrade proposal will be proposed which (if accepted) will schedule the upgrade on epoch **14209.** See the [Governance documentation](../../core/oasis-node/cli.md#gen_cast_vote) for details on voting for proposals.
...
* (optional) Vote for the upgrade. On 2021-06-21, an upgrade proposal will be proposed which (if accepted) will schedule the upgrade on epoch **7553.** See the [Governance documentation](../../core/oasis-node/cli.md#gen_cast_vote) for details on voting for proposals.
...
* (optional) Vote for the upgrade. On 2021-04-12 an upgrade proposal will be proposed which (if accepted) will schedule a network shutdown on epoch **5662.** See the [Governance documentation](../../core/oasis-node/cli.md#gen_cast_vote) for details on voting for proposals.
