...
If you've submitted staking or registry transactions before, your nonce is likely different than the nonce used in the examples. If you're uncertain, please check your account nonce by using [this guide](../../general/manage-tokens/cli/account.mdx#show).
...
*   `ACCOUNT_ADDRESS`: Your staking account address.
    ...
    To obtain your staking account address from your Entity's ID, see [Obtaining Account Address From Entity's ID](../../general/manage-tokens/cli/account.mdx#from-public-key).
...
<DocCard item={findSidebarItem('/general/manage-tokens/cli/account')} />
